                ...
                <table id="cost-center-detail-table" width="100%">
                  <thead>
                    <tr>
                      ...
                      <th style={{ border: "1px solid #111" }}>{new Date(props.showID.loading_time * 1000).toLocaleDateString("fa-IR")}</th>
                      ...
                      <th style={{ border: "1px solid #111" }}>{props.showID.hamlCompanyName}</th>
                    </tr>
                  </thead>
                </table>
                <br />
                ...
                >
                  ...
                  <tbody>
                    <tr style={{ alignItems: "center" }}>
                      ...
                      >
                        {props.showID.DrainInterval}
                      </td>
                      <td style={{ textAlign: "center" }}>
                        {props.showID.cargo_description}
                      </td>
                      <td style={{ textAlign: "center" }}>
                        {props.showID.weight}
                      </td>
                      <td style={{ textAlign: "center" }}>
                        {props.showID.originName}
                      </td>
                      <td style={{ textAlign: "center" }}>
                        {props.showID.destinationName}
                      </td>
                      <td style={{ textAlign: "center" }}>
                        {props.showID.lnsurance_value}
                      </td>
                      <td style={{ textAlign: "center" }}>
                        {props.showID.fare}
                      </td>
                ...
                >
                  ...
                  <tbody>
                    <tr style={{ alignItems: "center" }}>
                      ...
                      >
                        {props.showID.driverName != false ?
                        props.showID.driverName.name +
                          " " +
                          props.showID.driverName.lastName : null}
                      </td>
                      <td style={{ textAlign: "center" }}>
                      {props.showID.driverName != false ?
                        props.showID.driverName.hoshmandNumber : null}
                      </td>
                      <td style={{ textAlign: "center" }}>
