...
import BillingInformation from "layouts/barnameh/components/BillingInformation";

function Barnameh(props) {
  ...
  const getData = async (e) => {
    ...
    try {
      setLoading(true);
      const response = await fetch("https://hagbaar.com/api/Barnameh/getBarnameh", {
        mode: "cors",
        method: "POST",
        body: bodyFormData,
      });
...
export default connect(mapStateToProps, mapDispatchToProps)(Barnameh);
